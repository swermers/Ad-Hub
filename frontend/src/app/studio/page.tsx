...
export default function StudioPage() {
  ...
  return (
    <div className="max-w-5xl">
      ...
      {step === "Brief" && brief && (
        <div className="space-y-6">
          <div className="bg-white border border-white/10 rounded-xl p-6 space-y-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 text-sm font-medium bg-white border border-white/10 rounded-lg hover:bg-white/5"
            >
              Back to Edit
            </button>
            <button
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
              ...
              <div className="flex bg-gray-100 rounded-lg p-0.5">
                <button
                  ...
                  className={`px-2.5 py-1.5 text-xs font-medium rounded-md transition-all duration-150 ${
                    reviewView === "grid" ? "bg-white text-[#E5E1E4] shadow-sm" : "text-[#E5E1E4]/50 hover:text-[#E5E1E4]"
                  }`}
                >
                ...
                <button
                  ...
                  className={`px-2.5 py-1.5 text-xs font-medium rounded-md transition-all duration-150 ${
                    reviewView === "list" ? "bg-white text-[#E5E1E4] shadow-sm" : "text-[#E5E1E4]/50 hover:text-[#E5E1E4]"
                  }`}
                >
            ...
            <div className="flex gap-2">
              ...
              <button
                onClick={() => animateToStep("Input")}
                className="px-3 py-1.5 text-xs font-medium bg-white border border-white/10 rounded-lg hover:bg-white/5"
              >
                Start Over
              </button>
            </div>
          ...
          {reviewView === "grid" && (
            <div className="grid grid-cols-7 gap-2">
              {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((day) => {
                ...
                return (
                  <div key={day} className={`rounded-xl border p-2 min-h-[140px] ${bgColors[day] || "bg-gray-50 border-white/10"}`}>
          ...
          {reviewView === "list" && <div className="space-y-3">
            {pieces.map((piece) => {
              ...
              return (
                <div
                  key={piece.id}
                  className={`bg-white border border-white/10 rounded-xl overflow-hidden border-l-4 ${dayColor}`}
                >
                  {/* Card header */}
                  <div
                  ...
                  {isExpanded && (
                    <div className="px-5 pb-5 border-t border-white/5">
                          ...
                          <button
                            ...
                            className={`px-3 py-1.5 text-xs font-medium rounded-md capitalize transition-colors ${
                              (cardTab[piece.id] || "content") === tab
                                ? "bg-white text-[#E5E1E4] shadow-sm"
                      ...
                      <div className="mb-3">
                        ...
                        <div className="text-sm text-[#dbc2ad] leading-relaxed whitespace-pre-wrap bg-gray-50 rounded-lg p-4 max-h-64 overflow-y-auto">
                          {piece.body}
                        </div>
                      </div>
                        ...
                        <div className="mt-3">
                          ...
                          <div className="space-y-2">
                            {(meta.tweets as string[]).map((tweet, i) => (
                              <div
                                key={i}
                                className="bg-gray-50 rounded-lg p-3 text-sm text-[#dbc2ad] border-l-2 border-violet-300"
                              >
                        ...
                        <div className="mt-3">
                          ...
                          <div className="space-y-2">
                            {(meta.blocks as string[]).map((block, i) => (
                              <div
                                key={i}
                                className="bg-gray-50 rounded-lg p-3 text-sm text-[#dbc2ad] border-l-2 border-rose-300"
                              >
                      ...
                      <div className="flex gap-2 mt-4 pt-3 border-t border-white/5">
                        ...
                        <button
                          ...
                          className="px-3 py-1.5 text-xs font-medium bg-white text-[#dbc2ad] border border-white/10 rounded-lg hover:bg-white/5"
                        >
                          Edit
                        </button>
                        <button
                          ...
                          className="px-3 py-1.5 text-xs font-medium bg-white text-[#dbc2ad] border border-white/10 rounded-lg hover:bg-white/5 active:scale-95 transition-all duration-150 ml-auto"
                        >
                        ...
                        <div className="relative">
                          ...
                          {publishingPieceId === piece.id && (
                            <div className="absolute bottom-full right-0 mb-1 w-56 bg-white border border-white/10 rounded-lg shadow-lg z-10 p-2">
