...
- **Suggested command**: Which command to use (prefer: /extract, /audit, /animate, /optimize, /distill, /harden, /bolder, /colorize, /onboard, /adapt, /clarify, /normalize, /quieter, /polish, /delight, /critique — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /extract, /audit, /animate, /optimize, /distill, /harden, /bolder, /colorize, /onboard, /adapt, /clarify, /normalize, /quieter, /polish, /delight, /critique. You may also suggest other installed skills you're sure exist, but never invent commands.
