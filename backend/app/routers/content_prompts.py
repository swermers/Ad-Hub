"""Content Prompts Router — CRUD for per-product content pipeline prompts.

GET  /api/products/{id}/content-prompts       — returns current prompts (custom or defaults)
PUT  /api/products/{id}/content-prompts       — create/update custom prompt set
DELETE /api/products/{id}/content-prompts     — reset to defaults (delete custom set)
